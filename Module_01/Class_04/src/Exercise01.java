...
public class Exercise01 {
    public static void main(String[] args) {
         ...
         * Pedir al usuario que ingrese la temperatura y el tipo de conversión que desea
         * realizar.
         * 
         * Mostrar Resultados:
    ...
    public static double convertirAFahrenheit(double celsius) {
        return (celsius * 9.0 / 5.0) + 32; // Agregar lógica de conversión
    }

    // Método para convertir Fahrenheit a Celsius
    public static double convertirACelsius(double fahrenheit) {
